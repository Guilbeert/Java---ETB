...
public class GuilbertDAO {
    ...
    public void update(Guilbert guilbert) {
        String sql = "UPDATE guilberts SET nome = ?, cpf = ?, idade = ?, altura = ?, turma = ?, dataCadastro = ?, telefone = ? WHERE id = ?";
        ...
        try {
            ...
            pstm.setInt(1, guilbert.getId());
            pstm.setString(2, guilbert.getNome());
            pstm.setString(3, guilbert.getCpf());
            pstm.setInt(4, guilbert.getIdade());
            pstm.setInt(5, guilbert.getAltura());
            pstm.setString(6, guilbert.getTurma());
            pstm.setDate(7, new Date(guilbert.getDataCadastro().getTime()));
            pstm.setInt(8, guilbert.getTelefone());
    ...
    public void deleteById(int id) {
        String sql = "DELETE FROM guilberts WHERE id = ?";
